...
func (g *Galleries) Edit(w http.ResponseWriter, r *http.Request) {
    ...
    if gallery.UserID != user.ID {
        http.Error(w, "you do not have premission to edit this gallery", http.StatusForbidden)
        return
    }
...
func (g *Galleries) Delete(w http.ResponseWriter, r *http.Request) {
    ...
    user := context.User(r.Context())
    if gallery.UserID != user.ID {
        http.Error(w, "you do not have premmision to edit thi gallery", http.StatusForbidden)
        return
    }
...
func (g *Galleries) galleryByID(w http.ResponseWriter, r *http.Request) (*models.Gallery, error) {
    ...
    if err != nil {
        ...
        default:
            http.Error(w, "whoops, someting went wrong", http.StatusInternalServerError)
        }
...
func (g *Galleries) ImageDelete(w http.ResponseWriter, r *http.Request) {
    ...
    user := context.User(r.Context())
    if gallery.UserID != user.ID {
        http.Error(w, "you do not have premission to edit this gallery or image", http.StatusForbidden)
        return
    }
